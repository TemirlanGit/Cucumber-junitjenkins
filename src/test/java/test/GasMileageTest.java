...
public class GasMileageTest {
    ...
    public void gasMileageCalculatorTest() throws Exception {
        ...
        //loading the work book to class
        ...
        for(int rowNum = 1; rowNum <= sheet.getLastRowNum(); rowNum++) {
            ...
            // asking you would you like to run it or no
            ...
            gasMileageCalculatorPage.previosOdo.clear();
            gasMileageCalculatorPage.previosOdo.sendKeys(String.valueOf(previous));
