...
public class ExcelRead {
    ...
    public static void main(String[] args) throws  Exception{
        ...
        //This line is getting Sandler from sheet
        System.out.println(sheet.getRow(2).getCell(1));

        int usedRows = sheet.getPhysicalNumberOfRows();
        System.out.println("sheet.getPhysicalNumberOfRows: " + usedRows);

        int lastUsedRow = sheet.getLastRowNum();
        System.out.println("sheet.getLastRowNum: " + lastUsedRow);
        ...
        //TODO: CREATE A LOGIC THAT PRINTS OUT "ADAMS" JOB ID DYNAMICALLY
